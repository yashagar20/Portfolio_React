...
export const aboutData = [
  {
    ...
    info: [
      ...
      {
        title: 'Video Editing',
        icons: [<SiAdobepremierepro />, <SiAdobeaftereffects />, <SiAdobephotoshop />],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    info: [
      {
        title: 'UX/UI Designer - Fiver Freelancer',
        stage: '2012 - 2023',
      },
      {
        title: 'Web Developer - Intershalla And Fiver Freelancer',
        stage: '2021 - 2024',
      },
      {
        title: 'Intern - Globsyn Crystal, Infotech, Sports Keeda, Financial Consult',
        stage: '2021 - 2023',
      },
    ],
  },
  {
    ...
    info: [
      {
        title: 'Web Development - PW Skills',
        stage: '2023',
      },
      {
        title: 'Bachelor In Computer Application - Dr B.C Roy Engineering College',
        stage: '2024',
      },
      {
        title: 'Certified Video Editor',
        stage: 'Since- 2020',
      },
    ],
  },
    ...
    <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6">
      ...
      <div className="flex-1 flex flex-col justify-center">
        ...
        <motion.p variants={fadeIn('right', 0.4)} initial="hidden" animate="show" exit="hidden" className="max-w-[500px] mx-auto xl:mx-0 mb-6 xl:mb-12 px-2 xl:px-0">
          2 years ago, I began freelancing as a developer and video editor. Since then, I've done remote work for agencies, counsulted for startups, and collaborated on digital products for business and consumer use.
        </motion.p>
        {/* counters */}
